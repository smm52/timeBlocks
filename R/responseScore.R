...
#' @param sexColumn name of column that contains sex information (optional)
...
#' }
calculateResponseScore <- function(responseDf, idColumn = 'PATIENT', blockColumn = 'block', sexColumn = NA, responseColumns){
